...
class CheckerSuite(unittest.TestCase):
    ...
    def test21(self):
        ...
        """
        expect = "Type Mismatch In Expression: BinaryOp(+,BinaryOp(+,FieldAccess(Self(),Id(c)),FieldAccess(Self(),Id(a))),FieldAccess(Self(),Id(b)))"
    ...
    def test41(self):
        ...
        """
        expect = "Type Mismatch In Expression: NewExpr(Id(B),[IntLit(1),FloatLit(2.0)])"
    ...
    def test45(self):
        input = """
            ...
            Class Program{
             ...
             """
        expect = "Type Mismatch In Statement: AttributeDecl(Instance,VarDecl(Id(d),ArrayType(3,ArrayType(2,IntType)),[[IntLit(1),IntLit(2)],[IntLit(3),IntLit(4)],[IntLit(5),IntLit(6)],[IntLit(7),IntLit(8)]]))"
    ...
    def test71(self):
        input = """
            ...
            Class Program{
             ...
             """
        expect = "Type Mismatch In Statement: VarDecl(Id(a),IntType,CallExpr(Id(C),Id($method),[]))"
